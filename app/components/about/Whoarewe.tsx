        ...
        <div className='w-full mt-10 p-5'>
            <div className='flex flex-col gap-10 justify-center lg:flex-row lg:justify-between items-center'>
                <div className='flex max-w-[700px] flex-col gap-7'>
                    ...
                    <h2 className='text-[#001E62] max-w-[520px] text-4xl'>ჩვენ ვსპეციალიზირდებით <span className='text-[#D13851]'> მახალი ხარისხის სამშენებლო და სარემონტო მასალების  </span> მისოწების სერვისში </h2>
                ...
                <div className=" w-full max-w-[400px]">
                    ...
                    />
                    <div className=" bottom-5 left-5  bg-white rounded-xl shadow-md p-6 w-[70%] max-w-xs space-y-4">
