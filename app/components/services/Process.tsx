        ...
        <div className='w-full mt-10  mx-auto px-7'>
            <div className='flex lg:items-start  flex-col gap-7 justify-center items-center'>
                <div className="flex   items-center">
                    ...
                    <p className=" text-[#2A437C] text-xl lg:text-2xl  ">სამუშაო პროცესი</p>
                </div>
                {/* <div >
                ...
                <div>
                    <p className='text-[#556996] lg:text-xl max-w-[500px]'>ჩვენი პროცესი მარტივია, მაგრამ ეფექტური. თითოეული პროექტი უნიკალურია, თუმცა ჩვენ ვასრულებთ ყველას.</p>
