...
export default function Community() {
    ...
    return (
        <div className='w-full  p-7 '>
            <div className='lg:flex-row lg:justify-between flex flex-col  gap-5'>
                <div className='flex flex-col mt-8 gap-6'>
                    ...
                    <div className='flex flex-col gap-15'>
                        <h2 className='text-[#001E62] max-w-[700px] text-xl  lg:text-3xl  leading-tight'>{t('join')} <span className='text-[#D13851]'>{t('grow')}  {t('business')}</span> <br /> {t('logistic-partners')}</h2>
