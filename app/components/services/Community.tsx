            ...
            <div className='lg:flex-row flex flex-col  gap-5'>
                <div className='flex flex-col mt-8 gap-5'>
                    ...
                    <div className='flex flex-col gap-7'>
                        <h2 className='text-[#001E62] max-w-[500px] font-bold text-4xl '>Join a <span className='text-[#D13851]'>Growing <br /> Community</span> of Business and Logistics Partners </h2>
